...
RSpec.describe Greeting, type: :model do
  let(:template_text) { 'time firstName, and welcome to location! Room roomNumber is now ready for you. Enjoy your stay and let us know if you need anything!' }
  let(:greeting) { Greeting.new(company: '1', guest: '1', template: template_text) }
